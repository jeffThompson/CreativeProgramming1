![An operator at a SAGE console, using a light pen](https://raw.githubusercontent.com/jeffThompson/CreativeProgramming1/master/Images/Week07_Interactivity/SAGE-ConsoleOperator.jpg)
...
This week, your assignment is to build a sketch that responds to mouse and/or keyboard input in a visual way. How you approach this, and what it looks like, is up to you, but the result should be a unique exploration of interactivity and the visual.
...
* Interactive sketch that uses mouse input (keyboard optional)  
* Any dimensions, running in fullscreen mode  
* 3 images of the program running, either exported as `PNG` file using keyboard commands or screenshots  
* Read the exceprt from *10 PRINT CHR$* in the `Critical Code Studies` folder, found in the `Readings` section; write up a 1-paragraph response and post it as a comment on the assigment  
